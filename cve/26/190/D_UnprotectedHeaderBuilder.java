...
+
+/**
+ * A builder to create {@link UnprotectedHeader} instances.
+ *
+ * @since JJWT_RELEASE_VERSION
+ */
+public interface UnprotectedHeaderBuilder extends HeaderBuilder<UnprotectedHeader, UnprotectedHeaderBuilder> {
+
+}
