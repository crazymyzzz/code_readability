...
-
-/**
- * DB2 z/OS-specific function.
- */
-public class DB2zOSFunction extends Function {
-    /**
-     * Creates a new DB2 z/OS function.
-     *
...
-     */
-    DB2zOSFunction(JdbcTemplate jdbcTemplate, Database database, Schema schema, String name, String... args) {
