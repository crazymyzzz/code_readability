...
-
-public class DB2zOSDatabase extends Database<DB2zOSConnection> {
-
...
-        return new DB2zOSConnection(configuration, this, connection);
-    }
-
-    @Override
...
-                "CREATE UNIQUE INDEX \"" + table.getName() + "_pku\" ON \"" + table.getName() + "\" (\"installed_rank\");" +
...
-        return getMainConnection().getJdbcTemplate().queryForString("select CURRENT CLIENT_USERID from sysibm.sysdummy1");
-    }
-
-    @Override
